...
def build_model(input_shape=(48, 48, 3), num_classes=7, weights_path='mobilenet_v2_weights.h5'):
    ...
    Reference for MobileNetV2 setup: https://www.tensorflow.org/api_docs/python/tf/keras/applications/MobileNetV2
    Reference for downloading weights: https://stackoverflow.com/questions/49250523/how-to-download-a-file-over-http-using-python
    """
